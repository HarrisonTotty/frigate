...
const mockFrigate: ShipClassDetails = {
  id: 'frigate',
  name: 'Frigate',
  description: 'A versatile medium-sized warship designed for multi-role operations. Balances firepower, defense, and speed for diverse mission profiles.',
  size: 'Medium',
  role: 'Versatile',
  max_weight: 50000,
  max_modules: 8,
  ...
  notable_ships: ['UNS Constitution', 'UNS Enterprise', 'MCS Olympus', 'UNS Defiant', 'BAV Ceres', 'UNS Phoenix'],
};
