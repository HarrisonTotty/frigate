...
import { Modal, type ModalProps } from '../layout';
      ...
      <div>
        ...
        <form>
          <div style={{ marginBottom: 'var(--frigate-space-4)' }}>
            <label htmlFor="input1" style={{ display: 'block', marginBottom: 'var(--frigate-space-2)' }}>
              Input Field 1
            </label>
            <input
              id="input1"
          ...
          <div>
            <label htmlFor="input2" style={{ display: 'block', marginBottom: 'var(--frigate-space-2)' }}>
              Input Field 2
            </label>
            <textarea
              id="input2"
