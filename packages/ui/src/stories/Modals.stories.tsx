      ...
      <div style={{ padding: '2rem' }}>
        ...
        >
          <p style={{ margin: 0, fontFamily: 'var(--frigate-font-mono)', lineHeight: 1.6 }}>
            This is a basic centered modal with ASCII borders and keyboard handling.
            Press ESC to close or click the overlay.
          </p>
        </CenteredModal>
      </div>
    );
      ...
      <div style={{ padding: '2rem' }}>
        ...
        >
          <div style={{ fontFamily: 'var(--frigate-font-mono)' }}>
            <p>Try clicking the overlay or pressing ESC - you'll get a confirmation prompt.</p>
