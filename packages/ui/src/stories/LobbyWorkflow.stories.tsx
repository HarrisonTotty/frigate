...
// Mock data
const mockPlayers = [
  { id: 'p1', name: 'Commander Sarah Chen', callsign: 'PHEONIX', created_at: '2025-11-07T10:00:00Z' },
  { id: 'p2', name: 'Captain Marcus Blake', callsign: 'VIPER', created_at: '2025-11-06T15:30:00Z' },
  { id: 'p3', name: 'Lieutenant Yuki Tanaka', callsign: 'GHOST', created_at: '2025-11-05T08:45:00Z' },
];
...
const mockBlueprint = {
  ...
  team_id: 't1',
  modules: [
    { id: 'm1', module_id: 'fusion-core-mk2', slot: 0 },
    { id: 'm2', module_id: 'impulse-drive-standard', slot: 1 },
  ],
  crew_assignments: [
    { role: 'captain' as const, player_id: 'p1', player_name: 'Commander Sarah Chen', is_ready: true },
    { role: 'helm' as const, player_id: 'p2', player_name: 'Captain Marcus Blake', is_ready: false },
  ],
  build_points_used: 420,
  max_build_points: 600,
  is_validated: false,
  ...
  render: () => {
    ...
    return (
      <div style={{ height: '100vh', backgroundColor: 'var(--frigate-bg-primary)' }}>
        {step === 'player' && (
          <div>
            <div style={{ padding: '2rem', fontFamily: 'var(--frigate-font-mono)', color: 'var(--frigate-text-secondary)' }}>
        ...
        {step === 'ship' && selectedPlayer && selectedTeam && (
          <div>
            <div style={{ padding: '2rem', fontFamily: 'var(--frigate-font-mono)', color: 'var(--frigate-text-secondary)' }}>
...
export const WithMockAPI: StoryObj = {
  render: () => {
    ...
    if (typeof window !== 'undefined') {
      // @ts-ignore - Mock fetch for story
