...
describe("AmmunitionBrowser", () => {
  ...
  describe("empty state", () => {
    ...
    it("suggests disabling filter when compatible only and empty", () => {
      render(<AmmunitionBrowser {...defaultProps} ammunition={[]} showCompatibleOnly={true} />);
  ...
  describe("compatibility filtering", () => {
    ...
    it("calls onToggleCompatibleFilter when clicked", async () => {
      ...
      render(<AmmunitionBrowser {...defaultProps} onToggleCompatibleFilter={onToggle} />);
  ...
  describe("sorting", () => {
    ...
    it("changes sort order", async () => {
      ...
      // Custom combobox: click to open, click the option
      const sortSelect = screen.getByLabelText("Sort ammunition by");
      await user.click(sortSelect);

      const costOption = await screen.findByRole("option", { name: "COST" });
      await user.click(costOption);

      // After selecting COST, the combobox should display COST
      expect(within(sortSelect).getByText("COST")).toBeDefined();
    });
  });
  ...
  describe("showing details", () => {
    it("calls onShowAmmoDetails when card clicked", async () => {
      ...
      render(<AmmunitionBrowser {...defaultProps} onShowAmmoDetails={onShowAmmoDetails} />);
