...
export function ModuleSlotCard({
  ...
  const safeName =
    typeof slot.name === "string" && slot.name.length > 0 ? slot.name : "[Unnamed Slot]";
  ...
  const truncatedDescription =
    safeDescription.length > 50 ? safeDescription.substring(0, 47) + "..." : safeDescription;
  ...
  const tooltipStats: TooltipStatRow[] = [
    ...
    {
      label: "CREDIT COST",
      value: safeCreditCost > 0 ? formatCredits(safeCreditCost) : "---",
      unit: safeCreditCost > 0 ? "CR" : "",
    },
