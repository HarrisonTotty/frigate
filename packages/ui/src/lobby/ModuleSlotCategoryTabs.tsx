...
export function ModuleSlotCategoryTabs({ categories, selectedCategory, onSelect }: ModuleSlotCategoryTabsProps) {
  return (
    <div
      ...
      {categories.map(cat => (
        <button
          ...
          style={{
            ...
            color: selectedCategory === cat ? 'var(--frigate-text-inverse)' : 'var(--frigate-text-secondary)',
            fontWeight: 700,
            border: 'none',
            borderBottom: selectedCategory === cat ? '2px solid var(--frigate-primary)' : '2px solid var(--frigate-border-base)',
            borderRadius: 'var(--frigate-radius-none)',
