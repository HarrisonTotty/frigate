...
export function TeamListItem({ team, onJoin }: TeamListItemProps) {
  return (
    <div key={team.id} style={{ backgroundColor: 'var(--frigate-bg-surface)', border: '1px solid var(--frigate-border-base)', padding: 'var(--frigate-space-3)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <div style={{ flex: 1 }}>
