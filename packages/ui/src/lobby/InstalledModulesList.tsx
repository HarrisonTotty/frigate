...
export function InstalledModulesList({
  ...
  return (
    ...
    >
      {/* Header */}
      <div style={{ padding: 'var(--frigate-space-3)', borderBottom: '1px solid var(--frigate-border-base)' }}>
      ...
      {/* Footer */}
      <div style={{ padding: 'var(--frigate-space-3)', borderTop: '1px solid var(--frigate-border-base)' }}>
        <pre
          style={{
            margin: 0,
            color: 'var(--frigate-primary)',
