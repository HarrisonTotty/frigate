...
export function ModalShipClassDetailPanel({ shipClass, factionId }: ModalShipClassDetailPanelProps) {
  return (
    <Stack gap={4}>
      <ShipClassDetailPanel shipClass={shipClass} factionId={factionId} />
      <TechnicalSpecsGrid specs={shipClass.technical_specs} />
      <ShipClassBonusList bonuses={shipClass.bonuses} defaultExpandedCategories={["combat", "defense"]} />
    </Stack>
  );
}
