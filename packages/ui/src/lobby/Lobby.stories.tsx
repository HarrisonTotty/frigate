...
export const ShipStatsExample: StoryObj = {
  render: () => <ShipStatsPanel stats={{ cost: 200, creditCost: 150000, creditBudget: 1000000, shipClassCost: 50000, weight: 500, weightMax: 800, hp: 1000, power: 1200, powerMax: 1000, heat: 50, heatMax: 400, buildPointsUsed: 20, buildPointsMax: 100, warnings: ['Overweight'] }} />
};
