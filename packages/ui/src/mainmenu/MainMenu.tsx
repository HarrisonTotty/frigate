...
export function MainMenu({
  ...
  const getConnectionLabel = () => {
    switch (connectionStatus) {
      case 'disconnected': return 'CONN: NONE';
      case 'connecting': return 'CONN: HANDSHAKE';
      case 'connected': return 'CONN: ESTABLISHED';
      case 'error': return 'CONN: FAILED';
        ...
        <Stack gap={6}>
          ...
          {!bootComplete && (
            <div style={{
              ...
              {bootMessages.length > 0 && bootMessages.length < 5 && (
                <div>█</div>
              )}
            </div>
          )}
                ...
                <Stack gap={4}>
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        padding: '10px 12px',
                        backgroundColor: 'var(--frigate-bg-base)',
                        border: hasError ? '1px solid var(--frigate-danger)' : '1px solid var(--frigate-border-base)',
                        color: 'var(--frigate-text-primary)',
                        fontFamily: 'var(--frigate-font-mono)',
                  ...
                  <div style={{
                    ...
                    <div style={{
                      fontFamily: 'var(--frigate-font-mono)',
                      fontSize: 'var(--frigate-font-tiny)',
                      color: connectionStatus === 'connected' ? 'var(--frigate-success)' :
                             connectionStatus === 'connecting' ? 'var(--frigate-warning)' :
                             connectionStatus === 'error' ? 'var(--frigate-danger)' :
                    ...
                    {(isConnected || isConnecting) && (
                      <div style={{
                        ...
                        {serverVersion && (
                          <div>SERVER: HYPERION v{serverVersion}</div>
                        )}
