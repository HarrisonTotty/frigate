...
export function ModuleCatalog({
  ...
  const [remoteVariants, setRemoteVariants] = useState<ModuleVariant[] | null>(
    variants ? Array.from(variants) : null
  );
  ...
  // When variants are provided via prop, seed remoteVariants from them instead of
  // clearing so the modal can render without a fetch.
  useEffect(() => {
    setRemoteVariants(variants ? Array.from(variants) : null);
    setLoading(false);
    setInternalSelectedVariantId(null);
  }, [slotType?.id, variants]);
  ...
  // Fetch variants when catalog opens (only if none were provided via prop)
  useEffect(() => {
  ...
  return (
    <div style={catalogStyles.overlay} onClick={handleBackdropClick} role="presentation">
      <div
        ref={containerRef}
        className={className}
            ...
            <div style={catalogStyles.leftColumn}>
              {remoteVariants && remoteVariants.length > 0 ? (
                remoteVariants.map((v) => {
                  ...
                  const slotCreditCost =
                    typeof slotType?.credit_cost === "number" ? slotType.credit_cost : 0;
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        ...(selectedVariantId === v.id && {
                          backgroundColor: "var(--frigate-bg-selected)",
                        }),
                      }}
                      onMouseEnter={(e) => {
                        if (selectedVariantId !== v.id) {
                          (e.currentTarget as HTMLElement).style.backgroundColor =
                            "var(--frigate-bg-hover)";
                        }
                      }}
                      onMouseLeave={(e) => {
                        if (selectedVariantId !== v.id) {
                    ...
                    >
                      <div style={catalogStyles.variantInfo}>
                        ...
                        <div style={catalogStyles.variantDesc}>
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          const optionElement = (e.currentTarget as HTMLElement).closest(
                            '[role="option"]'
                          ) as HTMLElement;
                          if (optionElement) {
                            optionElement.click();
                ...
                <div
                  style={{ ...catalogStyles.emptyState, padding: "var(--frigate-space-6)" }}
                  role="status"
                >
                  <div
                    style={{
                ...
                {selectedVariantId ? (
                  (() => {
                    ...
                    const currentVariant = currentVariantId
                      ? remoteVariants?.find((v) => v.id === currentVariantId)
                      : null;
                    ...
                    const currentCost = currentVariant
                      ? (slotType?.base_cost ?? 0) + (currentVariant.cost ?? 0)
                      : 0;
                    ...
                    const selectedCreditCost =
                      slotCreditCost +
                      (typeof selectedVariant.credit_cost === "number"
                        ? selectedVariant.credit_cost
                        : 0);
                    const currentCreditCost = currentVariant
                      ? slotCreditCost +
                        (typeof currentVariant.credit_cost === "number"
                          ? currentVariant.credit_cost
                          : 0)
                      : 0;
                    const creditCostDelta = currentVariant
                      ? selectedCreditCost - currentCreditCost
                      : null;
                      ...
                      >
                          ...
                          >
                            <div>
                              ...
                              <div style={{ fontWeight: 700 }}>
                                {formatCredits(selectedCreditCost)} CR
                              </div>
                            </div>
                            {creditCostDelta !== null && creditCostDelta !== 0 && (
                              ...
                              >
                                {creditCostDelta > 0 ? "+" : ""}
                                {formatCredits(Math.abs(creditCostDelta))} CR
                              </div>
                            )}
                          </div>
                        )}
                        ...
                        >
                          ...
                          {typeof v.additional_weight === "number" && v.additional_weight !== 0 && (
                            <div>
                              ...
                              <div style={{ fontWeight: 600 }}>
                                {v.additional_weight > 0 ? "+" : ""}
                                {v.additional_weight} kg
                              </div>
                            </div>
                          )}
                          {typeof v.additional_power_consumption === "number" &&
                            v.additional_power_consumption !== 0 && (
                              <div>
                                <div
                                  style={{
                                    color: "var(--frigate-text-secondary)",
                                ...
                                <div style={{ fontWeight: 600 }}>
                                  {v.additional_power_consumption > 0 ? "+" : ""}
                                  {v.additional_power_consumption} MW
                                </div>
                              </div>
                            )}
                          {typeof v.additional_heat_generation === "number" &&
                            v.additional_heat_generation !== 0 && (
                              <div>
                                <div
                                  style={{
                                    color: "var(--frigate-text-secondary)",
                                ...
                                <div style={{ fontWeight: 600 }}>
                                  {v.additional_heat_generation > 0 ? "+" : ""}
                                  {v.additional_heat_generation} K
                                </div>
                              </div>
                            )}
                        </div>
                        ...
                        {(() => {
                          ...
                          const commonProps = new Set([
                            ...
                            "credit_cost",
                            "additional_hp",
                            "additional_power_consumption",
                            "additional_heat_generation",
                            "additional_weight",
                            "stats",
                          ]);
                          ...
                          const moduleParams = Object.entries(variantAny)
                            .filter(
                              ([key, value]) =>
                                !commonProps.has(key) && value !== undefined && value !== null
                            )
                  ...
                  <div style={catalogStyles.emptyState}>
                    ...
                    <div style={{ color: "var(--frigate-text-muted)", lineHeight: 1.4 }}>
                      Select a variant from the list to view detailed specifications, stats, and
                      lore.
                    </div>
                  </div>
                )}
