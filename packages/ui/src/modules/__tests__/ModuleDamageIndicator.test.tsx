...
import { ModuleDamageIndicator, ModuleDamageList, determineStatus, type ModuleStatus } from '../ModuleDamageIndicator';
...
describe('ModuleDamageList', () => {
  const testModules = [
    { id: '1', name: 'Fusion Core', category: 'Power', health: 100, status: 'operational' as ModuleStatus },
    { id: '2', name: 'Shield Gen', category: 'Defense', health: 45, status: 'damaged' as ModuleStatus },
