...
export const mockTeams = [
  {
    ...
    members: ['player-001', 'player-005', 'player-008', 'player-012', 'player-015', 'player-018', 'player-022', 'player-028'],
  ...
  },
  {
    ...
    members: ['player-003', 'player-006', 'player-010', 'player-013', 'player-016', 'player-020', 'player-023', 'player-026', 'player-029', 'player-031', 'player-034', 'player-037'],
...
export const mockBlueprints = [
  {
    ...
    crew_assignments: [
      { role: 'captain', player_id: 'player-001', player_name: 'Commander Sarah Chen', is_ready: true },
      { role: 'helm', player_id: 'player-002', player_name: 'Captain Marcus Blake', is_ready: false },
      { role: 'engineering', player_id: 'player-004', player_name: 'Engineer David Rodriguez', is_ready: true },
    ],
  ...
  },
  {
    ...
    crew_assignments: [
      { role: 'captain', player_id: 'player-005', player_name: 'Lt. Commander Elena Vasquez', is_ready: true },
      { role: 'helm', player_id: 'player-008', player_name: 'Pilot Jackson Wu', is_ready: true },
      { role: 'engineering', player_id: 'player-012', player_name: 'Chief Engineer Thomas O\'Brien', is_ready: true },
      { role: 'tactical', player_id: 'player-015', player_name: 'Tactical Officer Maya Patel', is_ready: true },
      { role: 'science', player_id: 'player-018', player_name: 'Science Officer Dr. Ahmed Hassan', is_ready: true },
      { role: 'comms', player_id: 'player-022', player_name: 'Comms Specialist Sofia Kowalski', is_ready: true },
      { role: 'energy_weapons', player_id: 'player-028', player_name: 'Weapons Officer Ivan Petrov', is_ready: true },
    ],
