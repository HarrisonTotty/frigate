...
export type {
  ShipClassDetailPanelProps,
  TechnicalSpecsGridProps,
  BuildConstraintsPanelProps,
} from "./shipclass";

// Export bonus display components (Phase 4.12.3)
export { ShipClassBonusList, BonusCategorySection, BonusItem } from "./shipclass";
export type {
  ShipClassBonusListProps,
  BonusCategorySectionProps,
  BonusItemProps,
} from "./shipclass";
